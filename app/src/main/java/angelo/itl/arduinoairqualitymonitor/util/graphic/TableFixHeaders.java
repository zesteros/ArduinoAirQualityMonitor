...
import angelo.itl.arduinoairqualitymonitor.adapter.table.TableAdapter;
...
public class TableFixHeaders extends ViewGroup {
    ...
    private int bottomMarginThumb;
    private int rightMarginThumb;
    ...
    public TableFixHeaders(Context context, AttributeSet attrs) {
        ...
        this.bottomMarginThumb =getResources().getDimensionPixelSize(R.dimen.thumb_bottom_margin);
        this.rightMarginThumb =getResources().getDimensionPixelSize(R.dimen.thumb_right_margin);
        this.thumb = new TextView(context);
        this.thumb.setTextSize(16);
        this.thumb.setText("prueba");
        this.thumb.setVisibility(INVISIBLE);
        this.thumb.setTextColor(Color.BLACK);
        this.thumb.setBackground(context.getResources().getDrawable(R.drawable.grid_shape));
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                currentX = x2;
                currentY = y2;
                if (flinger.scroller.timePassed() < 350) {
                    diffY *= 100;
                    thumb.setVisibility(VISIBLE);
                    thumb.setText(getActualElement());
                }
    ...
    public void scrollBy(int x, int y) {
        setActualRow(firstRow);
        setActualElement(adapter.getElementContent(firstRow, -1));
        scrollX += x;
        scrollY += y;
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        if (needRelayout || changed) {
            ...
            if (adapter != null) {
                ...
                //izq, arr, der, ab
                addShadow(thumb, right-rightMarginThumb, ((bottom-heights[0])/2), right, bottom-bottomMarginThumb);
    ...
    private void addShadow(TextView textView, int l, int t, int r, int b) {
    ...
    private View makeView(int row, int column, int w, int h) {
        ...
        adapter.getElementContent(row, column);
    ...
    public void setActualElement(String actualElement) {
